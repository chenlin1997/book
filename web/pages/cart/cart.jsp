...
<title>购物车</title>
	...
	<script type="text/javascript">
		$(function () {
			...
			//给输入框绑定change事件====onchange内容发生改变事件
	...
	<div id="main">
		...
		<table>
			...
			<c:if test="${empty sessionScope.cart.items}">
				<%--如果购物车为空的情况--%>
				<tr>
					<td colspan="5"><a href="index.jsp">当前购物车为空,快跟小伙伴浏览商品吧</a></td>
			...
			<c:if test="${not empty sessionScope.cart.items}">
				...
				<c:forEach items="${sessionScope.cart.items}" var="entry">
					<tr>
						...
						<td>
							<input class="updateCount" type="text" style="width: 80px; text-align: center"
